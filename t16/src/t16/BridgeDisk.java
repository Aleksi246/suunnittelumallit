...
class Stack {
    ...
    public Stack( String s ) {
        if (s.equals("array")) {
            ...
            impl = new StackList();
        } else if (s.equals("doublearray")) {
            impl = new StackDoubleArray();
        } else {
...
class StackDoubleArray implements StackImpl {
    private int[] items;
    private int total = -1;

    public StackDoubleArray() {
...
class StackGrowable extends Stack {
    private int growCount = 0;

    public StackGrowable() {
        super("doublearray");
    }
...
public class BridgeDisk {
    public static void main(String[] args) {
        Stack[] stacks = {new Stack("array"), new Stack("list"),
                new StackFIFO(), new StackHanoi(), new StackGrowable()};
        ...
        System.out.println("total grows is " + ((StackGrowable)stacks[4]).reportGrows());
    }
}
